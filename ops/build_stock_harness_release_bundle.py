...
RELEASE_FILES: List[str] = [
    ...
    "benchmarks/real_market_data_v1/README.md",
    "benchmarks/real_market_data_v1/claim_contract.json",
    "benchmarks/real_market_data_v1/REAL_MARKET_DATA_MANIFEST.json",
    "benchmarks/real_market_data_v1/sample_csv/SAMPLE_ETF.csv",
    "docs/BENCHMARK.md",
    "docs/CLAIMS.md",
    ...
    "tools/ralph/v0_3_real_market_agent.mjs",
...
DISALLOWED_PREFIXES = (
    ...
    "checkpoints/",
    "scenario_",
    "benchmarks/real_market_data_v1/sealed_csv/",
